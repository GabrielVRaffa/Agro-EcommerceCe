...
function CartPage() {
  ...
  const [hoverFechar, setHoverFechar] = useState(false);
      ...
      {cartItems.length === 0 ? (
        ...
        <>
              ...
              >
                ...
                <button
                  ...
                  style={{
                    marginTop: "10px",
                    backgroundColor:
                      hoveredRemove === item.id ? "#c44d4d" : "#a20202",
                    color: "#fff",
                    padding: "0.5rem 1rem",
                    border: "none",
                    borderRadius: "5px",
          ...
          <button
            ...
            onMouseEnter={() => setHoverFechar(true)}
            onMouseLeave={() => setHoverFechar(false)}
            style={{
              marginTop: "1rem",
              backgroundColor: hoverFechar ? "#218838" : "#28a745",
              color: "#fff",
